...
#define PH_SBJSONBASE_CLASS        PHSBJsonBase
#define PH_SBJSONPARSER_CLASS      PHSBJsonParser
#define PH_SBJSONWRITER_CLASS      PHSBJsonWriter
#define PH_SBJSONERRORDOMAIN_CONST PHSBJSONErrorDomain
#else
